...
SELECT 1
USE SHARED st_ifall ORDER CODIGO
pas405 = da_nombre()
Create table &PAS405 (pas_marca C(4),pas_desmarc;
C(35), pas_mode C(15), pas_desmode C(30),;
pas_monto N(9))
SELECT 2
Use &PAS405 EXCLUSIVE     
ppas = .T.
wk_hay = .F.
DO WHILE ppas
     @ 4, 30 SAY SPACE(35)
...
IF wk_hay = .T.
     SELECT 2
     GOTO TOP
     Index on pas_marca+pas_mode to &PAS405;
