...
DO WHILE ppas
     ...
     IF retorna = 1
          ...
          @ 4, 25 GET wk_feservi  ;
            PICTURE '!!/!!/!!'  ;
            VALID fecha()
          pregunta = 'indest#"N".and.fecfin=wk_feservi'
     ...
     IF retorna = 2
          ...
          @ 4, 45 GET wk_year  ;
            PICTURE '9999' VALID  ;
            a¥()
          pregunta = 'indest#"N".and.(year(fecfin)=wk_year).and.(month(fecfin)=wk_mes)'
...
*
PROCEDURE lis_arti4
tit1 = 'NRO. ORDEN      FECHA       NUMERO              MODELO               ESTADO         FECHA              FECHA          DIFERENCIA'
tit2 = '              SOLICITUD   SOLICITUD                                              COMPROMETIDA        REPARACION          DIAS   '
con_lin = 11
...
DO WHILE  .NOT. EOF()
     ...
     @ con_lin, 1 SAY pas_nume  ;
       PICTURE '99999999'
     @ con_lin, 14 SAY pas_fesoli
     @ con_lin, 22 SAY pas_numsol  ;
       PICTURE '99999999'
     @ con_lin, 32 SAY pas_desmod
     @ con_lin, 68 SAY pas_indori  ;
       PICTURE '@!'
     @ con_lin, 86 SAY pas_compre
     @ con_lin, 103 SAY  ;
       pas_fecfin
     @ con_lin, 124 SAY pas_dife  ;
       PICTURE '9999.99'
