...
pas4115 = da_nombre()
Create table &pas4115  ( pas_anorep N(2),;
pas_mesrep N(2), pas_codmod C(15), pas_nommod;
C(30),  pas_codmar C(4), pas_descri C(40),;
pas_valmao N(9,2), pas_valrep N(9,2))
SELECT 2
use &pas4115 exclusive  
DO WHILE ppas
     @ 4, 30 SAY SPACE(30)
     @ 4, 5 SAY SPACE(50)
     DO esc_modo WITH 'S'
     ...
     wk_year = INT(VAL(SUBSTR(STR(wk_anorep,  ;
               4), 3, 2)))
     Pregunta='wk_year = anorep.and.indori="&SIONO" '
     DO CASE
          CASE LASTKEY() == 27  ;
               .AND. efecin == 1
               ppas = .F.
     ...
     IF wk_hay = .F.
          DO error WITH  ;
             '** No Se Registran Tipos de Garantias **'
          LOOP
     ENDIF
