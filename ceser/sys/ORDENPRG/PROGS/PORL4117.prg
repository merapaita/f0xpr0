...
pas4117 = da_nombre()
Create table &pas4117 ( pas_anorep N(2),;
pas_mesrep N(2), pas_codmar C(4), pas_descri;
C(40), pas_valmao N(9,2), pas_valrep N(9,2))
SELECT 2
use &pas4117 exclusive     
DO WHILE ppas
     @ 4, 30 SAY SPACE(30)
     @ 4, 5 SAY SPACE(50)
     DO esc_modo WITH 'S'
     ...
     tit_impre = 'REPARACION POR MARCA'
...
IF wk_hay = .T.
     SELECT 2
     GOTO TOP
     Index on pas_codmar to &PAS4117;
