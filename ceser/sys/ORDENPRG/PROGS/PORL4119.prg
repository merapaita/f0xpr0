...
pas4119 = da_nombre()
Create table &PAS4119  ( pas_anorep N(2),;
pas_mesrep N(2), pas_codmod C(15), pas_nommod;
C(30),  pas_codmar C(4), pas_descri C(40),pas_valrep;
N(9))
SELECT 2
use &PAS4119 EXCLUSIVE   
DO WHILE ppas
     @ 4, 30 SAY SPACE(30)
     @ 4, 5 SAY SPACE(50)
     DO esc_modo WITH 'S'
     ...
     tit_impre = 'INFORME COSTO REPUESTO'
