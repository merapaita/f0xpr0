...
DO saycenter WITH 2,  ;
   ' SALIDA DE ARTICULOS POR UNIDADES'
@ 3, 2 CLEAR TO 5, 77
@ 3, 2 TO 5, 77
ppas = .T.
SELECT 1
...
pas4124 = da_nombre()
Create table &PAS4124 (pas_marca C(4),;
pas_indori C(4),pas_desmarc C(35), pas_mode;
C(15), pas_desmode C(35))
SELECT 2
use &PAS4124 EXCLUSIVE    
DO WHILE ppas
     @ 7, 1 CLEAR TO 13, 77
     @ 4, 30 SAY SPACE(30)
     @ 3, 2 TO 5, 77
     ...
     IF retorna = 1
          ...
          @ 4, 25 GET wk_feservi  ;
            PICTURE '!!/!!/!!'  ;
            VALID fecha()
          pregunta = 'indest="C".and.fecfin=wk_feservi'
     ...
     IF retorna = 2
          ...
          @ 4, 45 GET wk_year  ;
            PICTURE '9999' VALID  ;
            a¥()
          pregunta = 'indest="C".and.(year(fecfin)=wk_year).and.(month(fecfin)=wk_mes)'
...
IF wk_hay = .T.
     SELECT 2
     GOTO TOP
     Index on pas_marca+pas_indori+pas_marca;
to &PAS4124    
ENDIF
SELECT 3
USE
