...
DO WHILE .T.
     ...
     DO esc_indica WITH 2, 'BBB',  ;
        'BBB', 'BBB', 'ESC'
     SET CURSOR ON
     @ 04, 03 SAY 'Del T.Aten:'
     @ 04, 39 SAY 'Al  T.Aten:'
     @ 05, 03 SAY 'Del Emisor:'
     @ 05, 39 SAY 'Al  Emisor:'
     @ 06, 03 SAY 'Del Fecha :'
     @ 07, 03 SAY 'Al  Fecha :'
     ...
     @ 10, 03 SAY  ;
       'Pantalla/Impresora:'
     @ 04, 16 GET tipgar1 PICTURE  ;
       '@!' VALID valid2(tipgar1, ;
       22,'INGA') WHEN antes(1)
     @ 04, 52 GET tipgar2 RANGE  ;
     ...
     @ 05, 16 GET w_codem1  ;
       ...
       WHEN antes(1)
     @ 05, 52 GET w_codem2 RANGE  ;
       w_codem1 PICTURE '@!'  ;
       VALID valid2(w_codem2,57, ;
       'EMIS') WHEN antes(1)
     @ 06, 16 GET fecha1 WHEN  ;
       antes(2)
     @ 07, 16 GET fecha2 RANGE  ;
       fecha1 WHEN antes(2)
...
ge_tab0
     ...
     ELSE
          ...
          filidx = SYS(3)
          SELECT gara
          index on indori+tab_empres+codtall+dtos(fecfin)+entfac+numdoc;
to &filidx  
          GOTO TOP
          DO mensa WITH  ;
             '** Un momento, Por Favor ... **',  ;
