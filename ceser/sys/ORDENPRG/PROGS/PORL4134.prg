...
DO WHILE .T.
     ...
     ENDIF
     wrk_idx = f_indice()
     INDEX ON CODEMI+ESTADO+DTOS(DIA)+INDORI+ORDEN;
TO &WRK_IDX
...
st_iclpr
     ...
     ELSE
          wrk_fil2 = SUBSTR(f_texto(),  ;
                     ...
                     '.TXT'
          IF tipo = 'Detalle'
               repor form porl4134 to;
file &wrk_fil2 noconsole 
          ELSE
               repor form porl4134 to;
file &wrk_fil2 noconsole summary 
          ENDIF
          DO mensa WITH  ;
             '** Un momento, Por Favor ... **',  ;
             'SACA'
