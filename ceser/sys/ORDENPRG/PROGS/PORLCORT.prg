                       ...
                       'N'
                         ...
                         IF FOUND()
                              SCAN  ;
                               ...
                               .NOT.  ;
                               EOF()
                                   IF gc_pro00.pro_propie >= SUBSTR(w_proini, 1, 1) .AND. gc_pro00.pro_propie <= SUBSTR(w_profin, 1, 1)
                                        DO graba
                                        REPLACE codpro WITH st_idped.codpro
                                        REPLACE cantid WITH st_idped.canpro
                                        REPLACE preuni WITH st_idped.valpro
                                        REPLACE totite WITH st_idped.totite
                                        REPLACE cpsol WITH gc_pro00.pro_coprmb
                                        REPLACE cpdol WITH gc_pro00.pro_coprmo
                                        SELECT st_idped
                                   ENDIF
                              ENDSCAN
                         ENDIF
