...
b1 = ''
b2 = '°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°'
b3 = 'ÃÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄ´'
b4 = '0                      50%                    100%'
SET CURSOR ON
DO WHILE ppas
     STORE 0 TO w_totman,  ;
...
IF nreg = 0
     DO error WITH  ;
        '*** No hay informaci¢n para procesar ***'
     RETURN .T.
ENDIF
GOTO TOP
SEEK 'V'
...
IF creg = 0
     DO error WITH  ;
        '*** No Hay Informaci¢n para Actualizar ***'
     RETURN .T.
ENDIF
SELECT tabpre
GOTO TOP
campo = 'item+" "+ numpre+" "+dtoc(fecemi)+" "+numsol+" "+numord+" "+str(totant,9,2)+" "+str(totnue,9,2)+ " "+ str(totnue-totant,9,2)'
mensaje = 'N§ S/P.ÄÄ FEC.EMIÄÄ N§ S/S.ÄÄ N§ O/R.ÄÄ TOT.ANT.ÄÄTOT.NUE.ÄÄ DIFER. '
DO esc_indica WITH 1, 'AYU',  ;
   'TOD', 'BBB', 'SEL'
