...
IF LASTKEY() <> 27
     ...
     IF w_key == -1 .OR. w_key == - ;
        6
          ...
          IF FOUND()
               DO error2 WITH  ;
                  '** Documento, Existe Actualizar Tablas **'
               RETURN
          ELSE
               APPEND BLANK
          ENDIF
...
IF w_coddes = 'R'
     tit_tit5 = 'S O L I C I T U D   D E   S E R V I C I O'
ELSE
     tit_tit5 = '  SOLICITUD  DE  SERVICIO  A  DOMICILIO'
ENDIF
tit_fecha = w_fecha + ' - ' +  ;
            TIME()
tit_eminro = 'EMISOR :' +  ;
