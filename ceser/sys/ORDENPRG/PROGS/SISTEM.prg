...
DEFINE BAR 12 OF menu01 PROMPT  ;
       ...
       SKIP FOR nivell <> 'A7'  ;
       .AND. nivell <> 'A1'
DEFINE BAR 13 OF menu01 PROMPT  ;
       'Act\<ualiza S/Servicio'  ;
       SKIP FOR nivell <> 'A7'  ;
       .AND. nivell <> 'A1'
DEFINE BAR 14 OF menu01 PROMPT  ;
       '\-' SKIP FOR nivell <>  ;
       'A7'
DEFINE BAR 15 OF menu01 PROMPT  ;
       'T\<ipo de Cambio' SKIP  ;
       FOR nivell <> 'A7'
...
BAR()
DEFINE POPUP menu406 FROM 14, 22  ;
       COLOR SCHEME 21
...
DEFINE BAR 3 OF menu0415 PROMPT  ;
       '\<Facturaci¢n en Garant¡a x Modelo'  ;
       SKIP FOR nivell = 'A1'
