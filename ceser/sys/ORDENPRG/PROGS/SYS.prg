...
SET REFRESH TO 2
SET SYSMENU OFF
SET PATH TO ceser\aplic:sucu\ceser21
...
DEFINE BAR 7 OF menu01 PROMPT  ;
       'Cat logo de \<S¡ntomas'  ;
       SKIP FOR nivell <> 'A7'
DEFINE BAR 8 OF menu01 PROMPT  ;
       'Registro de Mano de \<Obra'  ;
       SKIP FOR nivell = 'A1'
DEFINE BAR 09 OF menu01 PROMPT  ;
       '\-'
DEFINE BAR 10 OF menu01 PROMPT  ;
       '\<Exporta Registros de Clientes'  ;
       SKIP FOR nivell <> 'A7'
DEFINE BAR 11 OF menu01 PROMPT  ;
       'Exporta Esta\<dist. AIWA'  ;
       SKIP FOR nivell <> 'A7'
ON SELECTION POPUP menu01 DO MENU10 WITH;
BAR()
DEFINE POPUP menu017 FROM 15, 20  ;
       COLOR SCHEME 21
DEFINE BAR 1 OF menu017 PROMPT  ;
       '\<Actualizaci¢n Manual'
DEFINE BAR 2 OF menu017 PROMPT  ;
       '\<Actualizaci¢n Autom tica'  ;
       SKIP FOR nivell <> 'A7'
ON SELECTION POPUP menu017 DO MENU017;
WITH BAR()
...
DEFINE BAR 5 OF menu029 PROMPT  ;
       ...
       SKIP FOR (nivell <> 'A7'  ;
       .AND. nivell <> 'A4')
DEFINE BAR 6 OF menu029 PROMPT  ;
       'Salida en \<Preventa  '  ;
       SKIP FOR (nivell <> 'A7')
DEFINE BAR 7 OF menu029 PROMPT  ;
       'Reingreso de \<Salida '  ;
       SKIP FOR (nivell = 'A1'  ;
       .OR. nivell = 'A2' .OR.  ;
       nivell = 'A3' .OR. nivell =  ;
...
WITH BAR()
DEFINE POPUP menu0702 FROM 16, 48  ;
       COLOR SCHEME 21
DEFINE BAR 1 OF menu0702 PROMPT  ;
       '\<Pedidos por NøFactura'
...
DEFINE BAR 18 OF menu409 PROMPT  ;
       'Ordenes Cerradas y Fact\<uradas'  ;
       SKIP FOR (nivell = 'A1'  ;
       .OR. nivell = 'A9')
...
WITH BAR()
DEFINE POPUP menu0411 FROM 09, 25  ;
       COLOR SCHEME 21
DEFINE BAR 1 OF menu0411 PROMPT  ;
       '\Ventas' SKIP FOR (nivell =  ;
       'A1' .OR. nivell = 'A2'  ;
       .OR. nivell = 'A9')
...
DEFINE BAR 3 OF menu0411 PROMPT  ;
       'M\<odelos por Marca'
DEFINE BAR 4 OF menu0411 PROMPT  ;
       '\Por \<T‚cnico' SKIP FOR  ;
       (nivell = 'A1' .OR. nivell =  ;
       'A9')
DEFINE BAR 5 OF menu0411 PROMPT  ;
       '\En \<Garantia' SKIP FOR  ;
       (nivell = 'A1' .OR. nivell =  ;
       'A9')
DEFINE BAR 6 OF menu0411 PROMPT  ;
       '\Fuera Garant¡a' SKIP FOR  ;
       (nivell = 'A1' .OR. nivell =  ;
       'A9')
DEFINE BAR 7 OF menu0411 PROMPT  ;
       '\Por Ma\<rca' SKIP FOR  ;
       (nivell = 'A1' .OR. nivell =  ;
       'A9')
DEFINE BAR 8 OF menu0411 PROMPT  ;
       '\Costo / Facturaci¢n'  ;
       SKIP FOR (nivell = 'A2'  ;
       .OR. nivell = 'A9')
DEFINE BAR 9 OF menu0411 PROMPT  ;
       '\Consumo de Repuestos'  ;
       SKIP FOR (nivell = 'A1'  ;
       .OR. nivell = 'A9')
DEFINE BAR 10 OF menu0411 PROMPT  ;
       '\<Tiempos de Atenci¢n     '
ON SELECTION POPUP menu0411 DO MENU0411;
WITH BAR()
DEFINE POPUP menu0412 FROM 17, 23  ;
       COLOR SCHEME 21
DEFINE BAR 1 OF menu0412 PROMPT  ;
       '\<1er. Ingreso al Taller'
...
DO WHILE .T.
     ...
     @ 0, 0 SAY  ;
       'ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿'
     @ 1, 0 SAY  ;
       '³ ACTUALIZACIONES ³   PROCESOS   ³  CONSULTAS  ³   REPORTES   ³ ADMINISTRACION ³'
     @ 2, 0 SAY  ;
       'ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ'
     ACTIVATE SCREEN
...
DO CASE
     ...
     CASE bar = 4
          DO porl4114
     CASE bar = 5
          DO porl4115 WITH 'GARA',  ;
             'EN GARANTIA'
     CASE bar = 6
          DO porl4115 WITH 'FGAR',  ;
             'FUERA DE GARANTIA'
     CASE bar = 7
          DO porl4117
     CASE bar = 8
