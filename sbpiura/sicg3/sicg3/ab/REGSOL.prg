...
DO CASE
     ...
     CASE estado = '20'
          DO standby WITH  ;
             'La O/S ya tiene Solicitud de Cotizaci¢n'
          RETURN
     CASE estado = '50'
          DO standby WITH  ;
             'Ya tiene O/S'
