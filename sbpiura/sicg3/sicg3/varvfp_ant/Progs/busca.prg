...
*SET PROCEDURE TO progs\SAI_LIB
*DO Fox_Ambi
...
cAno  = YEAR(DATE())
@ 02,01 SAY "       Opciones : " 
@ 01,20 GET vOpcion  FUNCTION '^ Ordenes de Compra;Asts Patrimoniales;Asts Presupuestales;Asts Orden;Notas de Contabilidad;Asignaciones Ingresos;Asignaciones Gastos;Cruce Ejec. Clase 8;Recinos de Ingreso;Saldos EE.FF.;Cruce Ing. Diario'
